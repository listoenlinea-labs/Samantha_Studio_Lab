...
ALTER TABLE catalogo_hallazgos
  ADD COLUMN IF NOT EXISTS clasificacion VARCHAR(20) NOT NULL DEFAULT 'MALO',
...
ALTER TABLE odontogramas
  ADD COLUMN IF NOT EXISTS fase VARCHAR(20) NOT NULL DEFAULT 'INICIAL',
  ADD COLUMN IF NOT EXISTS tipo_denticion VARCHAR(20) NOT NULL DEFAULT 'ADULTO',
  ADD COLUMN IF NOT EXISTS nomenclatura VARCHAR(20) NOT NULL DEFAULT 'FDI',
  ADD COLUMN IF NOT EXISTS observaciones TEXT NULL,
  ADD COLUMN IF NOT EXISTS estado VARCHAR(20) NOT NULL DEFAULT 'BORRADOR',
  ADD COLUMN IF NOT EXISTS created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ADD COLUMN IF NOT EXISTS finalizado_at DATETIME NULL;

ALTER TABLE odontograma_hallazgos
  ADD COLUMN IF NOT EXISTS id_catalogo_hallazgo INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS pieza VARCHAR(4) NULL,
  ADD COLUMN IF NOT EXISTS superficie VARCHAR(30) NULL,
